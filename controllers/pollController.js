...
exports.createPoll = async (req, res) => {
  ...
  req.flash(
    'success',
    `You successfully created <strong>${poll.name}</strong>. Share it with your friends!`
  );
...
exports.deletePoll = async (req, res) => {
  // delete the poll
  const pollToDelete = await Poll.find({ _id: req.body.pollIdToDelete })
    .remove()
    .exec();
