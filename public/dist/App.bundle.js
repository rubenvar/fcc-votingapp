...
module.exports.easing = __webpack_require__(78);
module.exports.canvas = __webpack_require__(77);
module.exports.options = __webpack_require__(79);
...
module.exports = {};
module.exports.Arc = __webpack_require__(73);
module.exports.Line = __webpack_require__(74);
module.exports.Point = __webpack_require__(75);
module.exports.Rectangle = __webpack_require__(76);
...
var helpers = __webpack_require__(0);
var basic = __webpack_require__(80);
...
var string = __webpack_require__(92);
...
function ajaxDelete(e) {
    ...
    var pollIdToDelete = e.explicitOriginalTarget.value;
    // find the whole card so we can make it disappear
    var pollCardToDelete = (0, _bling.$)('#poll-id-' + pollIdToDelete);
    // vanish the card (transition)
    vanish(pollCardToDelete);
    // and actually delete the poll POSTing the form action
    _axios2.default.post(this.action, { pollIdToDelete: pollIdToDelete }).then(function (res) {
...
function ajaxCancelDelete(e) {
    ...
    (0, _bling.$)('#poll-id-' + this.value).querySelector('.delete-conf').classList.remove('hidden'); // show the confirmation ask
}
...
exports.ajaxConfirmDelete = ajaxConfirmDelete;
exports.ajaxCancelDelete = ajaxCancelDelete;
...
var _loadChart = __webpack_require__(97);

var _loadChart2 = _interopRequireDefault(_loadChart);
...
function ajaxVote(e) {
    ...
    _axios2.default.post(this.action, { chosenId: chosenId, pollId: pollId }).then(function (res) {
        ...
        // display the chart
        (0, _loadChart2.default)(canvas, labels, data);
    }).catch(console.error);
}
 ...
 * @namespace Chart
 */
var Chart = __webpack_require__(69)();
...
module.exports = {};
module.exports.filler = __webpack_require__(83);
module.exports.legend = __webpack_require__(84);
module.exports.title = __webpack_require__(85);
...
var _newOption = __webpack_require__(30);
...
var voteForms = (0, _bling.$$)('form.vote');
voteForms.on('submit', _vote2.default);

var deleteConfButtons = (0, _bling.$$)('button.delete-first');
deleteConfButtons.on('click', _delete.ajaxConfirmDelete);

var deleteButtons = (0, _bling.$$)('form.delete');
deleteButtons.on('submit', _delete.ajaxDelete);
...
var addNewInPoll = (0, _bling.$$)('.new-option');
addNewInPoll.on('click', _newOption2.default);
